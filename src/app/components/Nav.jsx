            ...
            <div className="relative mx-auto flex max-w-screen-lg flex-col py-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <nav aria-label="Header Navigation" className="peer-checked:block hidden pl-2 py-6 sm:block sm:py-0">
                    <ul className="flex flex-col gap-y-4 sm:flex-row sm:gap-x-8">
                        ...
                        <li className=""><a className="text-gray-600 hover:text-blue-600" href="#">BEST</a></li>
                        <li className=""><a className="text-gray-600 hover:text-blue-600" href="#">BLOG</a></li>
                        <li className=""><a className="text-gray-600 hover:text-blue-600" href="#">DID YOU KNOW</a></li>
                        <li className=""><a className="text-gray-600 hover:text-blue-600" href="#">ABOUT ME</a></li>
                        <li className=""><a className="text-gray-600 hover:text-blue-600" href="#">CONTACT US</a></li>
